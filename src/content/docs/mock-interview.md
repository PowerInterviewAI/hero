# How to Mock an Interview

It's very simple! You can mock a realistic interview using **ChatGPT's voice mode**.
...
```
![Submit Prompt](/media/docs/mock-interview-3.png)

3. ChatGPT will immediately begin the interview simulation in **voice mode**.

![Interview Simulation Started](/media/docs/mock-interview-4.png)

---

**Tip**: Feel free to customize the prompt based on the specific role or skills you want to practice.
